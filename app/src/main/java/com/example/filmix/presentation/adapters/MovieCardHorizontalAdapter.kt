...
import com.example.filmix.databinding.ItemMovieCardHorizontalBinding
import com.example.filmix.domain.models.MovieItem
import java.util.Locale

class MovieCardHorizontalAdapter(
    private var movies: List<MovieItem>,
    private val onMovieClick: (MovieItem) -> Unit
) : RecyclerView.Adapter<MovieCardHorizontalAdapter.MovieViewHolder>() {
    ...
    override fun getItemCount(): Int = movies.size.coerceAtMost(10) // Максимум 10 элементов
    ...
    inner class MovieViewHolder(
        ...
        fun bind(movie: MovieItem) {
            ...
            val ratingBackground = when {
                movie.rating >= 8.0 -> R.drawable.bg_rating_gold
